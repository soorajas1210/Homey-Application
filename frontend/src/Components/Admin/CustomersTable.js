...
import { blockUserAction, usersList } from "../../actions/adminActions";
...
export default function CustomersTable() {
  ...
  const List = useSelector((state) => state.adminUsersList);
